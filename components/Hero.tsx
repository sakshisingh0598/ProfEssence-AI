...
const Hero = () => {
  return (
    <div className="pb-15 w-full">
      ...
      <div
        className="h-screen w-full dark:bg-black-100 bg-white dark:bg-grid-white/[0.06] bg-grid-black-100/[0.06]
      ...
      <div className="flex flex-col top-0 justify-center relative h-[70vh] z-10 items-center">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <p className="uppercase tracking-widest text-xs text-center text-yellow-400 max-w-80">
